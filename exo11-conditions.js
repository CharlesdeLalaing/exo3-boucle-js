...
let nombre1 = prompt("chiffre 1");
let nombre2 = prompt("chiffre 2");

if (nombre1 == nombre2) {
    alert(`Le chiffre1 et le chiffre2 sont-ils égaux ? : ${nombre1 == nombre2} `);
} else {
    alert("too bad");
};
...
if (nombre1 < nombre2) {
    alert(`Le nombre x et-il plus petit que le nombre y ? : ${nombre1 < nombre2} `);
} else {
    alert("too bad");
};
...
let nombre1 = prompt("chiffre 1");
let nombre2 = prompt("chiffre 2");
let nombre3 = prompt("chiffre 3");

if ((nombre1 + nombre2) > nombre3) {
    alert(`La somme du nombre x + le nombre y est-elle plus grande que le nombre z ? : ${((nombre1 + nombre2) > nombre3)}`)
...
let reponse = prompt("combien de character dans votre phrase?");
let juste = Math.abs(phrase.length - reponse);

if (phrase.length == reponse) {
    alert("pour le coup, bravo")
} else {
    alert(`pas loin c'est dommage, tu n'étais qu'a ${juste} character de la réponse`)
}
...
let question1 = confirm("veux-tu t'abboner?");

if (question1 == true) {
    let question2 = prompt("luxe ou normal").toLowerCase
        if (question2 == "luxe") {
            alert("Félicitation vous avez choisis la formule Luxe !")
        } else {
            alert("merci pour ce choix")
        }
} else {
    let question3 = confirm("certaine?");
        if (question3 == true) {
            alert("ok dommage")
        } else {
            let question4 = prompt("ha chouette, luxe ou normal?")
            if (question4 == "luxe") {
                alert("Félicitation vous avez choisis la formule Luxe !")
            } else {
                alert("merci pour ce choix")
...
let question2 = prompt("3+3=?");

if (question1 == 4 && question2 == 6) {
    alert("wow genial");
} else if (question1 == 4 && question2 != 6) {
    alert(`pas loin.. tu as eu juste à la premiere question mais la réponse du deuxieme était 6`)
} else if (question1 != 4 && question2 == 6) {
    alert(`pas loin.. la premiere reponse etait 4 mais tu as reussis la deuxieme!`)
} else {
    alert("nul t'a tous raté")
}
...
let x = confirm("riche oui ou non");
let y = confirm("vacance oui ou non");
let z = confirm("chat oui ou non");
